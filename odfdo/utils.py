...
def _make_xpath_query(element_name,
                      family=None,
                      text_style=None,
                      draw_id=None,
                      draw_name=None,
...
FAMILY_ODF_STD = set(('chart drawing-page graphic paragraph'
                      ' presentation ruby section table table-cell'
                      ' table-column table-row text').split())
...
OTHER_STYLES = set(('style:default-style style:header-style'
...
STYLES_TO_REGISTER = (set(FAMILY_MAPPING.values())
                      | OTHER_STYLES) - SUBCLASSED_STYLES
...
def _get_elements(context,
    ...
    for variable, childname in [(svg_title, 'svg:title'), (svg_desc,
                                                           'svg:desc'),
...
def _set_value_and_type(element,
                        value=None,
                        value_type=None,
                        text=None,
                        currency=None):
    # Remove possible previous value and type
    for name in ('office:value-type', 'office:boolean-value', 'office:value',
                 'office:date-value', 'office:string-value',
                 'office:time-value', 'table:formula', 'office:currency'):
        try:
