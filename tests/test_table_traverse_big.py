...
def test_traverse_1(table):
    counter = 0
    for row in table.traverse(0, 10000):
        counter += 1
...
def test_traverse_2(table):
    counter = 0
    for row in table.traverse(1000, 50000):
        counter += 1
...
def test_traverse_3(table):
    counter = 0
    for row in table.traverse(19000, 20000):
        counter += 1
    assert counter == 1001
...
def test_traverse_4(table):
    counter = 0
    for row in table.traverse(19000, 19000):
        counter += 1
    assert counter == 1
...
def test_traverse_5(table):
    counter = 0
    for row in table.traverse(10, 9):
        counter += 1
    assert counter == 0
